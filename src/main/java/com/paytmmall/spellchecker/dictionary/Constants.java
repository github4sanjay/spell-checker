package com.paytmmall.spellchecker.dictionary;
...
public class Constants {
    public static final List<String> STOP_WORDS = Arrays.asList(
            "coord", "gr", "tr", "td", "nbsp", "http", "https", "www", "a",
            ...
            "downing", "downs", "during", "e", "each", "early", "either", "end", "ended",
            "ending", "ends", "enough", "even", "evenly", "ever", "every", "everybody",
            "everyone", "everything", "everywhere", "f", "face", "faces", "fact", "facts",
            "far", "felt", "few", "find", "finds", "first", "for", "four", "from", "full",
            ...
            "high", "high", "high", "higher", "highest", "him", "himself", "his", "how",
            ...
            "m", "made", "make", "making", "many", "may", "me", "member", "members", "might",
            ...
            "younger", "youngest", "your", "yours", "z", "mg", "cm"
    );
